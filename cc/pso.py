...
class fitness_ret_t(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, fitness_ret_t, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, fitness_ret_t, name)
    __repr__ = _swig_repr
    __swig_setmethods__["fitness_value"] = _pso.fitness_ret_t_fitness_value_set
    __swig_getmethods__["fitness_value"] = _pso.fitness_ret_t_fitness_value_get
    if _newclass:
        fitness_value = _swig_property(_pso.fitness_ret_t_fitness_value_get, _pso.fitness_ret_t_fitness_value_set)
    __swig_setmethods__["coverage_info"] = _pso.fitness_ret_t_coverage_info_set
    __swig_getmethods__["coverage_info"] = _pso.fitness_ret_t_coverage_info_get
    if _newclass:
        coverage_info = _swig_property(_pso.fitness_ret_t_coverage_info_get, _pso.fitness_ret_t_coverage_info_set)

    def __init__(self):
        this = _pso.new_fitness_ret_t()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _pso.delete_fitness_ret_t
    __del__ = lambda self: None
fitness_ret_t_swigregister = _pso.fitness_ret_t_swigregister
fitness_ret_t_swigregister(fitness_ret_t)
...
class Optimizer(_object):
    ...
    def Run(self, energies, head_id):
        return _pso.Optimizer_Run(self, energies, head_id)
