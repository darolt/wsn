...
class fitness_ret_t(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["fitness_value"] = _genetic_algorithm.fitness_ret_t_fitness_value_set
    __swig_getmethods__["fitness_value"] = _genetic_algorithm.fitness_ret_t_fitness_value_get
    if _newclass:
        fitness_value = _swig_property(_genetic_algorithm.fitness_ret_t_fitness_value_get, _genetic_algorithm.fitness_ret_t_fitness_value_set)
    __swig_setmethods__["coverage_info"] = _genetic_algorithm.fitness_ret_t_coverage_info_set
    __swig_getmethods__["coverage_info"] = _genetic_algorithm.fitness_ret_t_coverage_info_get
    if _newclass:
        coverage_info = _swig_property(_genetic_algorithm.fitness_ret_t_coverage_info_get, _genetic_algorithm.fitness_ret_t_coverage_info_set)

    def __init__(self):
        this = _genetic_algorithm.new_fitness_ret_t()
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    __swig_destroy__ = _genetic_algorithm.delete_fitness_ret_t
    __del__ = lambda self: None
fitness_ret_t_swigregister = _genetic_algorithm.fitness_ret_t_swigregister
...
class Optimizer(_object):
    ...
    def Run(self, energies, head_id):
        return _genetic_algorithm.Optimizer_Run(self, energies, head_id)
