...
class PSO {
  public:
    PSO(dict_t exclusive, regions_t overlapping, vector<int> ids, int nb_particles);
    ~PSO();
  ...
  private:
    ...
    // methods
    float fitness(individual_t individual, vector<float> sleep_probs,
    ...
    int should_update(individual_t particle1, individual_t particle2);
};
#endif //PSO_H
